...
class DatabaseManager:
    ...
    def _initialize_database(self):
        ...
        try:
            # Skip database initialization if URL not provided
            if not settings.database_url:
                logger.warning("Database URL not provided, skipping database initialization")
                return
    ...
    def get_session_sync(self) -> Optional[Session]:
